...
// Overridable via CLAUDE_MEM_OPENROUTER_BASE_URL for local models (Ollama, LM Studio, etc.)
...
export class OpenRouterAgent {
  ...
  private getOpenRouterConfig(): {
    ...
    // Base URL: configurable for local models (Ollama: http://localhost:11434/v1, LM Studio: http://localhost:1234/v1)
